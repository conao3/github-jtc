    ...
    >
      <Panel title="照会条件" bodyClassName="p-0">
        <div className="flex flex-wrap items-center gap-2 border-b border-b-[#c5c5c5] bg-[#f4f6fa] px-2 py-1.5">
          <label>申請番号/件名</label>
          <input className="border border-[#888] px-1.5 py-0.5" placeholder="PR-2025-00089" />
          <label>状態</label>
      ...
      <Panel title="対象申請一覧" action={<span className={MUTED_CLASS}>該当 3件</span>} bodyClassName="p-0">
        <table className={TABLE_CLASS}>
          <thead>
            <tr>
              <th className="w-[120px]">申請番号</th>
              <th>件名</th>
              <th className="w-[90px]">申請者</th>
              <th className="w-[60px]">優先</th>
              <th className="w-[90px]">状態</th>
              <th className="w-[120px]">提出日時</th>
              <th className="w-[150px]">変更</th>
            </tr>
          </thead>
          <tbody>
