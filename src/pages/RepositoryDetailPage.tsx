  ...
  return (
    ...
    >
          ...
          <tbody>
            <tr>
              ...
              <td className={MONO_CLASS}>
                <b>{repoId}</b>{" "}
                <span className="text-xs text-slate-600">（決済システム基盤ソースコード）</span>
              </td>
              <th>管理ID</th>
        ...
        <table className={TABLE_CLASS}>
          <thead>
            <tr>
              ...
              <th className="w-28">更新日時</th>
              <th className="w-24">更新者</th>
              <th>最終コミットメッセージ</th>
      ...
      <Panel title="README.docx プレビュー">
        <div className={clsx("min-h-32 bg-amber-50 p-3 text-xs", MONO_CLASS)}>
          <div className="text-center text-sm font-bold">決済システム基盤 ソースコード管理リポジトリ</div>
          <div className="mb-2 text-right text-xs">令和8年4月25日 第3.2版</div>
