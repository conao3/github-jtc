  ...
  return (
    <div className={BODY_BG_CLASS}>
      <div className="flex h-full w-full flex-col border border-jtc-888 bg-jtc-e6e9ef">
        ...
        <div className="mx-auto flex min-h-0 flex-1 max-w-jtc-720 items-center overflow-auto px-6 py-10">
          <div className="w-full">
            <Panel title="GitHub App ログイン処理">
              {error !== null ? (
                <div className="space-y-2 text-11">
                  <div className="border border-jtc-b64242 bg-jtc-ffe0e0 px-3 py-2 text-jtc-8e0014">
                ...
                <div className="space-y-2 text-11">
                  <div className="border border-jtc-d4a000 bg-jtc-fff0c0 px-3 py-2">
                ...
                <div className="space-y-2 text-11">
                  <div className="border border-jtc-2a7f45 bg-jtc-dff3e5 px-3 py-2 text-jtc-176535">
